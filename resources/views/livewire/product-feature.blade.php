        ...
        <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
            ...
            <thead>
                <tr class="fw-bolder text-muted">
                    ...
                    <th class="min-w-140px"> صورة الميزة  </th>
                    <th></th>
                </tr>
            </thead>
            <!--end::Table head-->
            ...
            <tbody>
                ...
                @forelse( $Features as $item )
                    <tr>
                        ...
                        <td>
                            <p  class="text-dark fw-bolder text-hover-primary d-block fs-6">{{$item->product->name}}</p>
                        </td>

                        <td>
                             <img src="{{asset('storage/'.$item->image)}}" alt="" height="200px" width="200px">
                        </td>
