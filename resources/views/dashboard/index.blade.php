    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        <div class="container">
            <div class="row g-5 g-xl-8">
                <div class="col-xl-3">
                    ...
                    <a href="#" class="card bg-body hoverable card-xl-stretch mb-xl-8">
                        ...
                        <div class="card-body">
                            ...
                            <!--end::Svg Icon-->
                            <div class="text-gray-900 fw-bolder fs-2 mb-2 mt-5">{{$services}}</div>
                            <div class="fw-bold text-gray-400">الخدمات </div>
                        </div>
                        <!--end::Body-->
                    </a>
                ...
                <div class="col-xl-3">
                    ...
                    <a href="#" class="card bg-dark hoverable card-xl-stretch mb-xl-8">
                        ...
                        <div class="card-body">
                            ...
                            <!--end::Svg Icon-->
                            <div class="text-gray-100 fw-bolder fs-2 mb-2 mt-5">{{$testimonials}}</div>
                            <div class="fw-bold text-gray-100">العملاء</div>
                        </div>
                        <!--end::Body-->
                    </a>
                    <!--end::Statistics Widget 5-->
                ...
                <div class="col-xl-3">
                    ...
                    <a href="#" class="card bg-warning hoverable card-xl-stretch mb-xl-8">
                        ...
                        <div class="card-body">
                            ...
                            <!--end::Svg Icon-->
                            <div class="text-white fw-bolder fs-2 mb-2 mt-5">{{$articles}}</div>
                            <div class="fw-bold text-white">المقالات </div>
                        </div>
                        <!--end::Body-->
                    </a>
                    <!--end::Statistics Widget 5-->
                ...
                <div class="col-xl-3">
                    ...
                    <a href="#" class="card bg-info hoverable card-xl-stretch mb-5 mb-xl-8">
                        ...
                        <div class="card-body">
                            ...
                            <!--end::Svg Icon-->
                            <div class="text-white fw-bolder fs-2 mb-2 mt-5">{{$businesses}}</div>
                            <div class="fw-bold text-white">الأعمال</div>
                        </div>
                        <!--end::Body-->
                    </a>
                    <!--end::Statistics Widget 5-->
                ...
                <div class="col-xl-3">
                    ...
                    <a href="#" class="card bg-danger hoverable card-xl-stretch mb-5 mb-xl-8">
                        ...
                        <div class="card-body">
                            ...
                            <div class="fw-bold text-white">المنتجات الرقمية</div>
                        </div>
                        <!--end::Body-->
                    </a>
                    <!--end::Statistics Widget 5-->
                ...
                <div class="col-xl-3">
                    ...
                    <a href="#" class="card bg-success hoverable card-xl-stretch mb-5 mb-xl-8">
                        ...
                        <div class="card-body">
                            ...
                            <!--end::Svg Icon-->
                            <div class="text-white fw-bolder fs-2 mb-2 mt-5">{{$news_letter}}</div>
                            <div class="fw-bold text-white">النشرة البريدية </div>
                        </div>
                        <!--end::Body-->
                    </a>
                    <!--end::Statistics Widget 5-->
                ...
                <div class="col-xl-3">
                    <!--begin::Statistics Widget 5-->
                    <a href="#" class="card hoverable card-xl-stretch mb-5 mb-xl-8" style="background-color: #2eea38">
                        <!--begin::Body-->
                        <div class="card-body">
                            <!--begin::Svg Icon | path: icons/duotune/graphs/gra007.svg-->
                            <span class="svg-icon svg-icon-white svg-icon-3x ms-n1">
                            ...
                            <!--end::Svg Icon-->
                            <div class="text-white fw-bolder fs-2 mb-2 mt-5">{{$contacts}}</div>
                            <div class="fw-bold text-white">الرسائل الواردة </div>
                        </div>
                        <!--end::Body-->
                    </a>
                    <!--end::Statistics Widget 5-->
                ...
                <div class="col-xl-3">
                    <!--begin::Statistics Widget 5-->
                    <a href="#" class="card hoverable card-xl-stretch mb-5 mb-xl-8" style="background-color: #d813d5">
                        <!--begin::Body-->
                        <div class="card-body">
                            <!--begin::Svg Icon | path: icons/duotune/graphs/gra007.svg-->
                            <span class="svg-icon svg-icon-white svg-icon-3x ms-n1">
                            ...
                            <!--end::Svg Icon-->
                            <div class="text-white fw-bolder fs-2 mb-2 mt-5">{{$service_request}}</div>
                            <div class="fw-bold text-white">طلبات الخدمة </div>
                        </div>
                        <!--end::Body-->
                    </a>
                    <!--end::Statistics Widget 5-->
