        ...
        <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
            ...
            <thead>
                <tr class="fw-bolder text-muted">
                    <th class="min-w-150px">إسم المنتج </th>
                    <th class="min-w-140px"> العنوان الرئيسي</th>
                    <th class="min-w-140px">الوصف الرئيسي</th>
                    <th class="min-w-140px">رابط المنتج</th>
                    <th class="min-w-140px">رابط الفيديو</th>
                    <th class="min-w-140px">الصورة الرئيسية</th>
                    <th class="min-w-140px">الصورة المصغرة</th>
                    <th></th>
                </tr>
            </thead>
            <!--end::Table head-->
            ...
            <tbody>
                ...
                <tr>
                        ...
                        <td>
                            <p  class="text-dark fw-bolder text-hover-primary d-block fs-6">{{$item->main_title}}</p>
                        </td>
                        <td>
                            <p  class="text-dark fw-bolder text-hover-primary d-block fs-6">{{$item->main_description}}</p>
                        </td>
                        <td>
                            <p  class="text-dark fw-bolder text-hover-primary d-block fs-6">{{$item->product_url}}</p>
                        </td>
                        <td>
                            <p  class="text-dark fw-bolder text-hover-primary d-block fs-6">{{$item->video_url}}</p>
                        </td>

                        <td>
                             <img src="storage/{{$item->main_image}}" alt="" height="200px">
                        </td>
                        <td>
                            <img src="storage/{{$item->small_image}}" alt="" height="200px">
                       </td>
                        ...
                        <td>
                            <div class="d-flex justify-content-end flex-shrink-0">
                                ...
                                <!-- Modal -->
                                    ...
                                    <div  class="modal fade show" id="edit{{$item->id}}" tabindex="-1" aria-labelledby="edit{{$item->id}}Label" aria-hidden="true">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <!--begin::Form-->
                                                <form wire:submit.prevent="updateProduct({{$item->id}})" enctype="multipart/form-data">
                                                    <div>
                                                        @if (session()->has('message'))
                                                            <div class="alert alert-success">
                                                                {{ session('message') }}
                                    ...
                                    @endif
                                <form wire:submit.prevent="deleteProduct({{$item->id}})">
